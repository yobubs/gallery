...
export async function generateMetadata({
  ...
  const photo: Photo = await FetchPhoto(params.id)

  return {
    title: photo?.alt_description ?? "LuminaVision",
    description: photo?.description ?? "Error",
  }
}
...
export default async function PhotoDetails({
  ...
  if (!photo) throw new Error("cant fetch the photo")
